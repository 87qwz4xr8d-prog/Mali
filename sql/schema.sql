-- Mali Expense Control
-- Import ไฟล์นี้ผ่าน phpMyAdmin หรือ: mysql -u root -p < sql/schema.sql

CREATE DATABASE IF NOT EXISTS mali CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE mali;
